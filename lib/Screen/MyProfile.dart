...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  String? curPass, newPass, confPass, mobile, verifyPassword;
...
//==============================================================================
  ...
  Future<void> deleteAccountAPI(String mobile) async {
    ...
    Response response = await post(deleteUserApi, body: data, headers: headers)
...
//==============================================================================
  ...
  Future<void> setProfilePic(File imageFile) async {
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      try {
        var image;
